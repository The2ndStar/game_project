...
def other() :
    mail1 = pygame.image.load(r"C:\Users\Woranat\OneDrive\Desktop\algro\game_project\photo\mail1.png").convert_alpha()
    mail2 = pygame.image.load(r"C:\Users\Woranat\OneDrive\Desktop\algro\game_project\photo\mail2.png").convert_alpha()
    startpic = pygame.image.load(r"C:\Users\Woranat\OneDrive\Desktop\algro\game_project\photo\startpic.png").convert_alpha()
    return mail1,mail2,startpic

def background() :
    mail = pygame.image.load(r"C:\Users\Woranat\OneDrive\Desktop\algro\game_project\photo\เริ่มเกม (1).png").convert_alpha()
